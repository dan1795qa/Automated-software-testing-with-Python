...
from blocks.subteadings_right_online_consultant import Subheadings_right_online_consultant
...
@allure.description("Test 'subheadings_menu_elements_right_online_consultant'")
def test_subheadings_menu_elements_right_online_consultant(set_up, set_group):
    ...
    print('-' * 100)
    print("Start test 'subheadings_menu_elements_right_online_consultant'")
    print('-' * 100)
    sbh_r = Subheadings_right_online_consultant(driver)
    sbh_r.subheadings_menu_elements_right_online_consultant()
    print("Finish test 'subheadings_menu_elements_right_online_consultant'")
    print('-' * 100)